...
if(NOT DEFINED IDA_64_BIT_EA_T)
    set(IDA_64_BIT_EA_T OFF CACHE BOOL "Use 64-bit ea_t. Set this to build 64-bit code capable IDA plugins.")
endif()

if(IDA_64_BIT_EA_T)
    message(STATUS "IDA SDK will be built as 64-bit ea_t.")
    set(suffix "64")
else()
    message(STATUS "IDA SDK will be built as 32-bit.")
    set(suffix "32")
endif()
    ...
    if(WIN32)
        if(${IDA_64_BIT_EA_T})
            if(${IDA_SDK_VERSION} GREATER_EQUAL 700)
                ...
                message(STATUS "IDA SDK version 7.0 or later detected, using 64-bit plugin extension.")
            else()
            ...
            if(${IDA_SDK_VERSION} GREATER_EQUAL 700)
                ...
                message(STATUS "IDA SDK version 7.0 or later detected, using 32-bit plugin extension.")
            else()
